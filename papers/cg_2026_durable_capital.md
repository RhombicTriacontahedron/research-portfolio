...
[^2]: At $\sigma>1$, $Y/K$ tends to a positive constant as $x\to+\infty$: capital income is at least $\underline AK$, and the proof’s choice of $\bar X$ then requires $i\underline A<\delta$.
