...
The paper derives a positive lower bound, at unit elasticity of substitution, on the capital-income tax that a capital owner sets himself when the revenue funds a public stock that reproduces the labour he hires, and shows that the bound survives when capital is durable. A tax on capital income fills a public stock that reproduces labour nobody owns. A fraction of capital survives each period. The law that fills the public stock does not use depreciation. A zero tax still means a zero public stock.

The owner sets the tax and nothing else: the share of profit he reinvests and the direction of technique stay fixed. When capital lasts, log-affine owner values disappear, so the owner’s preferred tax can no longer be read off a closed form. At Cobb–Douglas every path on which the tax stays below a positive threshold, not only one on which it is driven to zero, takes capital, labour and capital income to zero. Above Cobb–Douglas the same is true exactly when capital’s own output at the limit of deepening, reinvested at the fixed share, falls short of depreciation. At Cobb–Douglas the owner’s preferred tax also never falls below a floor written in the discount factor, the weight the owner puts on holding capital, labour’s share and the reproduction weight, and that floor holds at every state whatever the rate of wear. Whenever the owner’s chosen tax does not raise the capital stock a sharper floor applies, and that one rises as capital becomes more durable. Along the path the owner chooses, wherever capital settles, the long-run tax obeys that sharper floor.

------------------------------------------------------------------------

## Introduction

In the optimal programmes of Chamley (1986) and Judd (1985) a tax on capital income goes to zero in the long run, and the revenue pays for government consumption or for transfers. Here the same tax pays for an input into next period’s labour, and capital’s owner sets it. There are two classes. Owners hold the capital. Workers hold no assets and choose nothing. Labour is not an asset anyone accumulates: next period’s workforce moves, by a law nobody chooses, towards a weighted average in logs of this period’s wage bill and a public stock, and a tax on capital income is the only instrument that fills that stock. The owner sets the tax each period and nothing else. The share of profit he reinvests is held fixed, and so is the direction of technique, which the literature on directed technical change treats as a choice (Kennedy 1964; Acemoglu 2002). The tax he chooses, as the solution of his own dynamic programme, is the *assigned* tax. Capital is owned; successor labour, the workforce that law produces for next period, is not.

Durability is what makes the question live. When capital lasts one period, a take from current profit and a capital-income tax are the same map into next period’s consumption, capital and public stock. When some capital survives, that map splits: the tax still fills the public stock, but surviving machines no longer have to be rebuilt from after-tax profit. An owner who inherits much of next period’s capital might then seem to have less reason to fund the workforce. The law that fills the public stock does not use depreciation, so a zero tax still means a zero public stock at every rate of wear. The question is whether the owner’s reason to fund that stock dies when capital lasts. At Cobb–Douglas it does not. On every feasible path, chosen by the owner or not, a vanishing tax empties the public stock, the workforce follows it down, and capital income goes with them. On the owner’s own path what keeps the tax from vanishing is a floor rather than that collapse: at every state and every rate of wear, the tax he chooses stays above a positive constant of the parameters.

What the owner will not shut is the public stock that reproduces the labour he hires. Next period’s public stock enters his continuation with a strictly positive loading on the domain $\theta_R<1$, $\gamma>0$, where it reaches labour at all.[^1] Surviving machines split the map from after-tax profit into new capital; they do not remove that loading. Against Chamley and Judd, and against Judd (1999), who keeps the zero when the spending is chosen, three things change: the revenue is an input into the labour the owner hires, the capital tax alone pays for it, and the owner chooses the rate. At $\delta=1$ and Cobb–Douglas the floor needs the second of these: given a wage tax as well, the owner still funds the stock, but out of wages, and sets the capital tax to zero (Proposition 15). There, what carries the floor is the funding instrument, and not the usefulness of the spending alone.

At Cobb–Douglas, every feasible path on which the tax stays below a positive threshold from some date on, and in particular every path on which it vanishes, takes capital, labour, the public stock and capital income to zero (Proposition 5). Above Cobb–Douglas the same is true exactly when capital’s own output at the limit of deepening, reinvested at the fixed share, falls short of depreciation (Proposition 5$'$). At Cobb–Douglas the owner’s best response at every state stays above an explicit floor $\bar\tau>0$ that does not move with the rate of wear (Proposition 10). On that face, where the tax he chooses does not raise the capital stock, a sharper floor applies and rises as capital becomes more durable, and along his own path, wherever capital settles, the long-run tax obeys the sharper floor (Proposition 11 and the corollaries that follow it).

### Related literature

In Chamley (1986) the revenue pays for a given stream of government consumption, and in Judd (1985) for government consumption and transfers to workers who hold no assets; in neither is it an input into labour. Where public spending is instead a productive input, the case for taxing capital changes. Financing a public input with a capital tax can be efficient, though not when producing the input has economies of scale (Matsumoto and Feehan 2010); taxing capital can be optimal even when a labour tax is available (Feehan and Batina 2007); and when publicly provided education and health care drive growth and population is endogenous, the second-best taxes on capital and labour income turn on whether that input is optimally provided (Renström and Spataro 2021). In each of these a government sets the tax. Here capital’s owner sets it, and the input reproduces the labour he hires.

Judd (1999) is the nearest neighbour on spending. His spending is chosen and enters utility and production, human capital is accumulated privately by the agent who owns it, the planner can tax wages as well as capital, and the long-run capital tax is still zero: “rational government expenditure does not imply positive taxation of capital income” (p. 17). Here the spending is an input into a labour force nobody owns and the capital tax alone funds it; once the owner can also tax wages, Proposition 15 reaches Judd’s zero from the owner’s side at $\delta=1$. Straub and Werning (2020) show that inside Judd’s (1985) model the long-run tax is positive when the intertemporal elasticity of substitution is below one, and at unit elasticity whenever redistribution towards workers is desirable. That tax is chosen by a planner who weighs workers; the assigned tax is the owner’s own.

Galor and Moav (2006) are the nearest neighbour on mechanism. Their capitalists support a tax spent on workers’ schooling because educated workers complement their capital; their capital lasts one generation, and their tax is zero until capital per worker passes a critical level. On the Cobb–Douglas face both papers share, the assigned owner never takes the tax below the floor $\bar\tau$, at any state and any rate of wear.
...
*Environment* sets out the two classes, the technology, the three laws of motion (capital, the public stock and labour) and who chooses what. *Laws that survive* shows that the law filling the public stock does not use depreciation, so a zero tax empties the stock at every rate of wear, and that once some capital survives the owner’s value is no longer affine in logs, so the closed forms of the one-period case are lost. *Stationary assigned tax* writes the owner’s exact first-order condition, in which next period’s public stock enters through the reproduction weight at every rate of wear. At $\delta=1$ and Cobb–Douglas that condition gives the same tax at every state, and the constant is the owner’s unique optimal plan (Proposition 2). *Paths, not only stationary points* turns to the object Chamley and Judd study, a tax path, and proves the two path results above without using any optimality condition. At Cobb–Douglas it also shows that a zero tax at a single date is never the owner’s choice (Proposition 4). *Interior policy at a given state* shows that at Cobb–Douglas the owner’s best response exists at every state, so he neither shuts down nor confiscates. *A floor that does not move with the state* proves the floor and the sharper floor, then runs the same argument downwards to cap the tax at every elasticity of substitution at least one. At Cobb–Douglas every best response therefore lies in a band fixed by the parameters, and the band can exclude the economy’s rest points: under a condition on the parameters there is an interval of rates of wear at which rest points exist but none of them is a tax the owner would choose (Proposition 13), and under a further condition his own path runs down an economy that a constant tax he could levy would grow (Proposition 14). *Stationary first-order condition* records which substitutions would make the peak a closed form in $\delta$, and why none of them is licensed. *Contact with Chamley and Judd* states what the contact rests on, why the floor does not rest on commitment, what a wage tax does to it, and how the two models nearest on mechanism differ. The Conclusion collects the answer.
...
**Proposition 6 (Interior policy at a given state).** Let $\sigma=1$, $\varphi=1$, $\theta_R\in(0,1)$, $\gamma\in(0,1)$, $\omega\in[0,1)$, $\delta\in(0,1]$ and $i\in(0,1)$. At every finite state $(K,n,g)$, $W$ is continuous on $(0,1)$ and $W(\tau)\to-\infty$ as $\tau\to 1^-$ and as $\tau\to 0^+$. A maximiser $\tau^*(K,n,g)\in(0,1)$ therefore exists.[^6]
...
**Proposition 7 (What a fixed point still needs).** Let $\sigma=1$ and maintain the hypotheses of Proposition 6. Lemma 6 does not give a state $(K,n,g)$ for every $\tau$ at fixed $i$. It gives a curve $i=i(\tau,\delta)$ on which intensive stationarity holds; the scale $n$ remains a state. Proposition 6 still gives $\tau^*(K,n,g)\subset(0,1)$ at each given state. A stationary peak is a pair $(\tau,i(\tau,\delta))$ that is a best response at some scale of that intensive point.[^7]
...
Then no maximiser $\tau^*(K,n,g)$ of $W$ lies in $(0,\bar\tau)$ — at any state, for every $\delta\in(0,1]$ and every $i\in(0,1)$.[^8]
...
At Cobb–Douglas the answer to the question the paper opens with is a number and not only a sign. The assigned owner’s tax never falls below $\bar\tau=c/(1+c)$, with $c$ the ratio of what one log point of public stock is worth to him — two periods away, through the reproduction weight and labour’s share — to what it costs him in consumption and in capital. That floor holds at every state and at every rate of wear, whenever the capital tax is the instrument that fills the stock. When a wage tax can fill it too, at $\delta=1$ he fills it out of wages and leaves capital income untaxed (Proposition 15). At a tax that does not raise the capital stock, durability enters only the cost, and it lowers it: the more of next period’s capital he inherits rather than buys, the smaller the part of it the tax touches. At the durable limit that sharper floor is $\beta^2(1-\alpha)\gamma(1-\theta_R)$ in odds form. Along his own optimal path, wherever capital settles, the long-run tax obeys the sharper floor: this is the model’s counterpart of Chamley and Judd’s long-run statement. At Cobb–Douglas, when the revenue reproduces labour nobody owns, the durability that separates a capital-income tax from a take out of current profit does not release the assigned owner from funding the stock; at a tax that does not raise the capital stock it raises the floor.
