...
A public stock that sustains the working class, funded only by a tax on profits, changes what a labour account can say. At an interior rest point of two-class laws of motion, a labour-only charge conserves production exactly when replacement takes less than the product. Under any defensible charging rule it conserves workers’ reproduction only inside a growth window narrower than the capital share. What a worker’s period yields beyond its cost is owner consumption plus the net growth of both stocks. In a growing economy no such rule removes this remainder; its ratio to the charge is an interval, degenerate only when public investment is zero, and moving the tax from cash towards the stock widens it more than in proportion.
